...
/**
 * 教师端主界面 (MainTeacherView.fxml) 的控制器。
 * 基于学生端MainViewController修改，移除教务功能
 * 核心职责：
 * 1. 响应左侧导航栏的按钮点击。
 * 2. 在中央内容区动态加载和切换不同的功能模块视图。
 * 编写人：AI Assistant
 */
public class MainTeacherViewController {

    // 这个AnchorPane对应MainTeacherView.fxml中<center>区域的容器，fx:id="mainContentPane"
    @FXML
    ...
    @FXML
    private Button teacherRecordButton; // 教师信息管理，对应学生端的学籍管理
    ...
    public void initialize() {
        ...
        // ------------------ 接口点: MainTeacherViewController -> WelcomeView.fxml ------------------
    ...
    private void updateUserInfo() {
        if (userInfoLabel != null) {
            ...
            if (userSession.isLoggedIn()) {
                userInfoLabel.setText("👤 当前教师: " + userSession.getCurrentUserDisplayName());
            } else {
    ...
    private void showLoginView() {
        try {
            ...
            // 设置并显示登录界面窗口
            loginStage.setTitle("VCampus 教师端 - 登录");
    ...
    void handleStoreNav(ActionEvent event) {
        // ------------------ 接口点: MainTeacherViewController -> StoreView.fxml ------------------
    ...
    /**
     * 当用户点击"教师信息管理"导航按钮时调用。
     * 复用学生端的学籍管理界面，但显示教师信息
     * @param event 点击事件
     */
    @FXML
    ...
    private void updateButtonTexts() {
        if (isSidebarExpanded) {
            ...
            teacherRecordButton.setText("📋 教师信息");
            ...
            teacherRecordButton.setText("📋");
            emailButton.setText("📧");
            // 当侧边栏折叠时，清空AI助手按钮的文本（只留图标）
            chatButton.setText("");
        }
    }
}
