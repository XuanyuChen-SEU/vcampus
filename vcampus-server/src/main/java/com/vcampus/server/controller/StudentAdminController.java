...
public class StudentAdminController {
    ...
    public Message searchStudents(Message request) {
        try {
            ...
            if (!(data instanceof String)) {
                return Message.failure(ActionType.UPDATE_STUDENT, "参数错误，必须是 String 对象");
            }
    ...
    public Message updateStudent(Message request) {
        try {
            ...
            if (ok) {
                return Message.success(ActionType.UPDATE_STUDENT, "更新成功");
            } else {
                return Message.failure(ActionType.UPDATE_STUDENT, "更新失败");
            }
        } catch (Exception e) {
            e.printStackTrace();
